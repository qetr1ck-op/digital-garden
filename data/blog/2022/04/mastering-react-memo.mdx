...
`React.memo` is here to rescue. The signature is pretty straightforward:
...
## How React Memoizes is different from traditional and why the real name should be - `renderIfPropsHaveChanged` =)
